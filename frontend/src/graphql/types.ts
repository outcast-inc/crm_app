...
export type UpcomingEventsQuery = {
  events: Pick<Types.EventConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.Event, "_id" | "title" | "color" | "startDate" | "endDate">
    >;
  };
};
...
export type AccountSettingsGetUserQuery = {
  user: Pick<
    Types.User,
    "_id" | "name" | "email" | "avatarUrl" | "jobTitle" | "phone" | "timezone"
  >;
};
...
export type NotificationsQuery = {
  audits: Pick<Types.AuditConnection, "totalCount"> & {
    nodes: Array<
      Pick<
        Types.Audit,
        "_id" | "action" | "targetEntity" | "targetId" | "createdAt"
      > & {
        user?: Types.Maybe<Pick<Types.User, "_id" | "name" | "avatarUrl">>;
      }
    >;
  };
};
...
export type NotificationsDealsQuery = {
  deals: {
    nodes: Array<
      Pick<Types.Deal, "_id" | "title"> & {
        stage?: Types.Maybe<Pick<Types.DealStage, "_id" | "title">>;
        company: Pick<Types.Company, "_id" | "name" | "avatarUrl">;
      }
    >;
  };
};
...
export type EventCategoriesQuery = {
  eventCategories: Pick<Types.EventCategoryConnection, "totalCount"> & {
    nodes: Array<Pick<Types.EventCategory, "_id" | "title">>;
  };
};
...
export type CompaniesSelectQuery = {
  companies: {
    nodes: Array<Pick<Types.Company, "_id" | "name" | "avatarUrl">>;
  };
};
...
export type ContactsSelectQuery = {
  contacts: {
    nodes: Array<Pick<Types.Contact, "_id" | "name" | "avatarUrl">>;
  };
};
...
export type DealStagesSelectQuery = {
  dealStages: { nodes: Array<Pick<Types.DealStage, "_id" | "title">> };
};
...
export type UsersSelectQuery = {
  users: { nodes: Array<Pick<Types.User, "_id" | "name" | "avatarUrl">> };
};
...
export type AdministrationUsersQuery = {
  users: Pick<Types.UserConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.User, "_id" | "name" | "jobTitle" | "role" | "avatarUrl">
    >;
  };
};
  ...
  events: Pick<Types.EventConnection, "totalCount"> & {
    nodes: Array<
      Pick<
        ...
        | "createdAt"
      > & {
        createdBy: Pick<Types.User, "_id" | "name">;
        category: Pick<Types.EventCategory, "_id" | "title">;
      }
    >;
  };
};
...
export type CreateEventCategoriesMutation = {
  createManyEventCategories: Array<Pick<Types.EventCategory, "_id" | "title">>;
};
...
> & {
  createdBy: Pick<Types.User, "_id" | "name">;
  category: Pick<Types.EventCategory, "_id" | "title">;
  participants: Array<Pick<Types.User, "_id" | "name">>;
};
...
export type CompanyContactsTableQuery = {
  contacts: Pick<Types.ContactConnection, "totalCount"> & {
    nodes: Array<
      Pick<
        Types.Contact,
        "_id" | "name" | "avatarUrl" | "jobTitle" | "email" | "phone" | "status"
      >
    >;
  };
};
...
export type CompanyContactsGetCompanyQuery = {
  company: Pick<Types.Company, "_id" | "name"> & {
    salesOwner: Pick<Types.User, "_id">;
  };
};
...
export type CompanyDealsTableQuery = {
  deals: Pick<Types.DealConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.Deal, "_id" | "title" | "value"> & {
        stage?: Types.Maybe<Pick<Types.DealStage, "_id" | "title">>;
        dealOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
        dealContact: Pick<Types.Contact, "_id" | "name" | "avatarUrl">;
      }
    >;
  };
};
...
export type CompanyCreateCompanyNoteMutation = {
  createOneCompanyNote: Pick<Types.CompanyNote, "_id" | "note">;
};
...
export type CompanyCompanyNotesQuery = {
  companyNotes: Pick<Types.CompanyNoteConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.CompanyNote, "_id" | "note" | "createdAt"> & {
        createdBy: Pick<Types.User, "_id" | "name" | "updatedAt" | "avatarUrl">;
      }
    >;
  };
};
...
export type CompanyUpdateCompanyNoteMutation = {
  updateOneCompanyNote: Pick<Types.CompanyNote, "_id" | "note">;
};
...
export type CompanyQuotesTableQuery = {
  quotes: Pick<Types.QuoteConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.Quote, "_id" | "title" | "status" | "total"> & {
        company: Pick<Types.Company, "_id" | "name">;
        contact: Pick<Types.Contact, "_id" | "name" | "avatarUrl">;
        salesOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
      }
    >;
  };
};
...
export type CompanyTitleFormMutation = {
  updateOneCompany: Pick<Types.Company, "_id" | "name" | "avatarUrl"> & {
    salesOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
  };
};
...
export type CompanyTitleQuery = {
  company: Pick<Types.Company, "_id" | "name" | "createdAt" | "avatarUrl"> & {
    salesOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
  };
};
...
export type CreateCompanyMutation = {
  createOneCompany: Pick<Types.Company, "_id" | "name"> & {
    salesOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
  };
};
...
export type CompaniesTableQuery = {
  companies: Pick<Types.CompanyConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.Company, "_id" | "name" | "avatarUrl"> & {
        dealsAggregate: Array<{
          sum?: Types.Maybe<Pick<Types.CompanyDealsSumAggregate, "value">>;
        }>;
        salesOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
...
export type ContactsCreateContactNoteMutation = {
  createOneContactNote: Pick<Types.ContactNote, "_id" | "note">;
};
...
export type ContactsUpdateContactNoteMutation = {
  updateOneContactNote: Pick<Types.ContactNote, "_id" | "note">;
};
...
export type ContactsContactNotesListQuery = {
  contactNotes: Pick<Types.ContactNoteConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.ContactNote, "_id" | "note" | "createdAt"> & {
        createdBy: Pick<Types.User, "_id" | "name" | "avatarUrl">;
      }
    >;
  };
};
...
export type ContactsListQuery = {
  contacts: Pick<Types.ContactConnection, "totalCount"> & {
    nodes: Array<
      Pick<
        Types.Contact,
        "_id" | "name" | "email" | "jobTitle" | "status" | "avatarUrl"
      > & { company: Pick<Types.Company, "_id" | "name" | "avatarUrl"> }
    >;
  };
};
...
> & {
  ...
  company: Pick<
    Types.Company,
    "_id" | "name" | "country" | "website" | "avatarUrl"
  >;
  salesOwner: Pick<Types.User, "_id" | "name">;
  contact: Pick<Types.Contact, "_id" | "name">;
};
...
export type TaskStagesSelectQuery = {
  taskStages: { nodes: Array<Pick<Types.TaskStage, "_id" | "title">> };
};
...
export type KanbanCreateStageMutation = {
  createOneTaskStage: Pick<Types.TaskStage, "_id" | "title" | "createdAt">;
};
...
export type KanbanCreateTaskMutation = {
  createOneTask: Pick<Types.Task, "_id">;
};
...
export type KanbanUpdateStageMutation = {
  updateOneTaskStage: Pick<Types.TaskStage, "_id" | "title">;
};
...
export type KanbanGetTaskQuery = {
  task: Pick<
    Types.Task,
    "_id" | "title" | "completed" | "description" | "dueDate"
  > & {
    stage?: Types.Maybe<Pick<Types.TaskStage, "_id" | "title">>;
    users: Array<Pick<Types.User, "_id" | "name" | "avatarUrl">>;
...
export type KanbanTaskCommentsQuery = {
  taskComments: Pick<Types.TaskCommentConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.TaskComment, "_id" | "comment" | "createdAt"> & {
        createdBy: Pick<Types.User, "_id" | "name" | "avatarUrl">;
      }
    >;
  };
...
export type KanbanTaskStagesQuery = {
  taskStages: Pick<Types.TaskStageConnection, "totalCount"> & {
    nodes: Array<Pick<Types.TaskStage, "_id" | "title">>;
  };
};
...
export type KanbanTasksQuery = {
  tasks: Pick<Types.TaskConnection, "totalCount"> & {
    nodes: Array<
      Pick<
        Types.Task,
        "_id" | "title" | "description" | "dueDate" | "completed" | "stageId"
      > & {
        checklist: Array<Pick<Types.CheckListItem, "title" | "checked">>;
        users: Array<Pick<Types.User, "_id" | "name" | "avatarUrl">>;
...
export type SalesCompaniesSelectQuery = {
  companies: {
    nodes: Array<
      Pick<Types.Company, "_id" | "name" | "avatarUrl"> & {
        contacts: {
          nodes: Array<Pick<Types.Contact, "name" | "_id" | "avatarUrl">>;
        };
      }
    >;
  };
...
export type SalesCreateDealStageMutation = {
  createOneDealStage: Pick<Types.DealStage, "_id">;
};
...
export type SalesCreateContactMutation = {
  createOneContact: Pick<Types.Contact, "_id">;
};
...
export type SalesUpdateDealStageMutation = {
  updateOneDealStage: Pick<Types.DealStage, "_id" | "title">;
};
...
export type SalesUpdateDealMutation = {
  updateOneDeal: Pick<
    Types.Deal,
    "_id" | "title" | "stageId" | "value" | "dealOwnerId"
  > & {
    company: Pick<Types.Company, "_id"> & {
      contacts: {
        nodes: Array<Pick<Types.Contact, "_id" | "name" | "avatarUrl">>;
      };
    };
    dealContact: Pick<Types.Contact, "_id">;
  };
};
...
export type SalesFinalizeDealMutation = {
  updateOneDeal: Pick<
    Types.Deal,
    "_id" | "notes" | "closeDateYear" | "closeDateMonth" | "closeDateDay"
  >;
};
...
export type SalesDealStagesQuery = {
  dealStages: Pick<Types.DealStageConnection, "totalCount"> & {
    nodes: Array<
      Pick<Types.DealStage, "_id" | "title"> & {
        dealsAggregate: Array<{
          sum?: Types.Maybe<Pick<Types.DealStageDealsSumAggregate, "value">>;
        }>;
      }
...
export type SalesDealsQuery = {
  deals: {
    nodes: Array<
      Pick<Types.Deal, "_id" | "title" | "value" | "createdAt" | "stageId"> & {
        company: Pick<Types.Company, "_id" | "name" | "avatarUrl">;
        dealOwner: Pick<Types.User, "_id" | "name" | "avatarUrl">;
      }
    >;
