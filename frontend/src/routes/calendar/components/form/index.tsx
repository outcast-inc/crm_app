...
export const CalendarForm: React.FC<CalendarFormProps> = ({
    ...
    const { selectProps: categorySelectProps, queryResult: categoryQueryResults } = useSelect<
    ...
    const { selectProps: userSelectProps, queryResult: userQueryResults } = useUsersSelect();
        ...
        <Form layout="vertical" form={form} {...formProps}>
            ...
            <Row gutter={[32, 32]}>
                <Col span={12}>
                    ...
                    >
                        <Select 
                            options={
                                categoryQueryResults.data?.data?.map((category) => ({
            ...
            >
                <Select 
                    ...
                    {...userSelectProps}
                    options={
                        userQueryResults.data?.data?.map((user) => ({
                            label: user.name,
                            value: user._id
                        }))
                    }
