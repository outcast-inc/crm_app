...
export const SalesPage: FC<PropsWithChildren> = ({ children }) => {
    ...
    const handleOnDragEnd = (event: DragEndEvent) => {
        ...
        if (stageId === "won") {
            stageId = stageGrouped.stageWon?._id;
        }

        if (stageId === "lost") {
            stageId = stageGrouped?.stageLost?._id;
        }
    ...
    const getContextMenuItems = (column: DealStageColumn) => {
        ...
        const items: MenuProps["items"] = [
        {
            ...
            icon: <EditOutlined />,
            onClick: () => handleEditStage({ stageId: column._id }),
        },
        {
            ...
            onClick: () =>
            handleClearCards({
                dealsIds: column.deals.map((deal) => deal._id),
            }),
        },
        {
            danger: true,
            ...
            icon: <DeleteOutlined />,
            disabled: hasItems,
            onClick: () => handleDeleteStage({ stageId: column._id }),
        },
        ];
        ...
        <>
            <KanbanBoard onDragEnd={handleOnDragEnd}>
                ...
                {stageGrouped.stageAll.map((column) => {
                    ...
                    return (
                        ...
                        >
                                    ...
                                    >
                                        <DealKanbanCardMemo 
                                            ...
                                            user={{
                                                ...
                                                avatarUrl: deal.dealOwner.avatarUrl as string,
                                            }}
                                            date={deal.createdAt}
                                            price={currencyNumber(deal.value || 0)}
                                        />
                            ...
                            {!column.deals.length && (
                                <KanbanAddCardButton 
                                    onClick={() => handleAddCard({ stageId: column._id })}
                                />
                            )}
                        </KanbanColumn>
                    );
                ...
                {stageGrouped.stageWon && (
                    <KanbanColumn
                        key={stageGrouped.stageWon._id}
                        id={stageGrouped.stageWon._id}
                ...
                {stageGrouped.stageLost && (
                    <KanbanColumn
                        key={stageGrouped.stageLost._id}
                        id={stageGrouped.stageLost._id}
