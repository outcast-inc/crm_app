...
import { KanbanCreatePage, KanbanCreateStage, KanbanEditPage, KanbanEditStage, KanbanPage } from "./routes/scrumboard/kanban";
import { SalesCreatePage, SalesCreateStage, SalesEditPage, SalesEditStage, SalesFinalizeDeal, SalesPage } from "./routes/scrumboard/sales";
import { CompanyCreatePage, CompanyEditPage, CompanyListPage } from "./routes/companies";
import { ContactCreatePage, ContactShowPage, ContactsListPage } from "./routes/contacts";
import { QuotesCreatePage, QuotesEditPage, QuotesListPage, QuotesShowPage } from "./routes/quotes";
import { CalendarCreatePage, CalendarEditPage, CalendarPageWrapper, CalendarShowPage } from "./routes/calendar";
